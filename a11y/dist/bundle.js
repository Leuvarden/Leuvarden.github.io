...
var _KeyCode = __webpack_require__(/*! ./KeyCode */ "./KeyCode.js");

var _KeyCode2 = _interopRequireDefault(_KeyCode);

var _FocusTrap = __webpack_require__(/*! ./FocusTrap */ "./FocusTrap.js");
...
var Menu = function () {
    function Menu(containerId, items) {
        _classCallCheck(this, Menu);

        this.items = items;
        this.$widgetContainer = (0, _jquery2.default)('#' + containerId);
        this.$dropdownItems = [];
    }
    ...
    _createClass(Menu, [{
        ...
        value: function drawMenu() {
            this.$widgetButton = (0, _jquery2.default)('<button>', {
                'class': 'btn btn-lg btn-primary',
                'aria-haspopup': 'true',
                'text': 'Dialog button',
                'type': 'button'
            });
            this.$widgetDiv = (0, _jquery2.default)('<div>', {
            ...
            this.$applyButton = (0, _jquery2.default)('<button class="btn btn-primary">Apply changes</button>');

            this.$widgetDiv.append('<div></div>').append(this.$applyButton);
            this.$closeButton = (0, _jquery2.default)('<button type="button" class="close" aria-label="Close">×</button>');
            this.$widgetDiv.append(this.$closeButton).prepend('<h4 id="dateWidgetH4">Change options</h4>');
            this._addEventListeners();
        }
    }, {
        key: '_addMenuItems',
        value: function _addMenuItems() {
            var _this = this;

            this.items.forEach(function (item, index) {
                var $menuItem = (0, _jquery2.default)('<input type="radio" name="dialogRadio" class="form-check-input">');
                if (item.isSelected) {
                    $menuItem.attr('checked', '');
                }
                _this.$dropdownItems.push($menuItem);

                var $label = (0, _jquery2.default)('<label>' + item.text + '</label>');
                $label.prepend($menuItem);
                var div = (0, _jquery2.default)('<div class="form-check"></div>');
                div.append($label);
                _this.$widgetDiv.append(div);
                _this.$widgetDiv.append(_this.$applyButton);
            });
        }
    }, {
        ...
        value: function _addEventListeners() {
            ...
            this.$widgetDiv.keydown(function (e) {
                return _this2._handleKeydownOnDropdownItems(e);
            });
            this.$closeButton.on('keydown', function (e) {
                if (e.keyCode === _KeyCode2.default.TAB) {
                    _this2.$widgetButton.focus();
                }
            });

            this.$closeButton.on('click', function () {
                _this2.collapsePopup();
            });
        }
    }, {
        key: 'togglePopup',
        ...
        key: 'expandPopup',
        value: function expandPopup() {
            this.$widgetDiv.css("display", "block");
            this.$widgetDiv.attr("aria-expanded", "true");
            this.$widgetDiv.find("input[checked]").eq(0).focus();
        }
    }, {
        key: 'collapsePopup',
        value: function collapsePopup() {
            this.$widgetDiv.css("display", "none");
            this.$widgetDiv.removeAttr("aria-expanded");
            this.$widgetButton.focus();
        }
    }, {
        key: '_handleKeydownOnDropdownItems',
        value: function _handleKeydownOnDropdownItems(event) {
...
function getFocusableElementsInContainer(container) {
    ...
    $container.find(focusableSelector).filter(":visible").filter(filterKeepNormalElements).each(function (i, val) {
        result.push({
            v: val, // value
            t: 0, // tabIndex
    ...
    $container.find("[tabindex]").filter(":visible").filter(filterKeepSpeciallyFocusable).each(function (i, val) {
        result.push({
            v: val, // value
    ...
    result = _jquery2.default.map(result.sort(sortFocusable), // needs stable sort
    function (val) {
        return val.v;
    });
...
var _Menu2 = __webpack_require__(/*! ./Menu */ "./Menu.js");
...
var SelectableMenu = function (_Menu) {
    _inherits(SelectableMenu, _Menu);

    function SelectableMenu(containerId, items) {
        _classCallCheck(this, SelectableMenu);

        return _possibleConstructorReturn(this, (SelectableMenu.__proto__ || Object.getPrototypeOf(SelectableMenu)).call(this, containerId, items));
    }

    _createClass(SelectableMenu, [{
        key: 'drawMenu',
        value: function drawMenu() {
            this.$widgetButton = (0, _jquery2.default)('<button>', {
                'class': "btn btn-lg btn-primary ",
        ...
        key: '_addMenuItems_ie',
        value: function _addMenuItems_ie() {
            var _this2 = this;
            ...
            this.items.forEach(function (item, index) {
                ...
                $menuItem.attr('aria-setsize', _this2.items.length);

                _this2.$widgetList
                // .append('<span class="dropdown-divider">')
                .append($menuItem);
                _this2.$dropdownItems.push($menuItem);
            });
        }
    }]);
...
exports.default = SelectableMenu;
...
var Menu = function () {
    ...
    _createClass(Menu, [{
        ...
        value: function expandPopup() {
            ...
            this.$widgetList.find("li").eq(0).focus();
        }
    }, {
        key: 'collapsePopup',
        value: function collapsePopup() {
        ...
        key: '_handleKeydownOnDropdownItems',
        value: function _handleKeydownOnDropdownItems(event) {
            var $currentItem = (0, _jquery2.default)(event.target);
            var $firstItem = this.$dropdownItems[0];
            var $lastItem = this.$dropdownItems[3];
            var $previousItem = (0, _jquery2.default)(event.target).prev();
            var $nextItem = (0, _jquery2.default)(event.target).next();
...
var _ieTemplate = __webpack_require__(/*! ./templates/ieTemplate.html */ "./templates/ieTemplate.html");

var _ieTemplate2 = _interopRequireDefault(_ieTemplate);

var _simpleMenu = __webpack_require__(/*! ./templates/simpleMenu.html */ "./templates/simpleMenu.html");

var _simpleMenu2 = _interopRequireDefault(_simpleMenu);

var _checkboxesMenu = __webpack_require__(/*! ./templates/checkboxesMenu.html */ "./templates/checkboxesMenu.html");

var _checkboxesMenu2 = _interopRequireDefault(_checkboxesMenu);

var _Dialog = __webpack_require__(/*! ./templates/Dialog.html */ "./templates/Dialog.html");

var _Dialog2 = _interopRequireDefault(_Dialog);

var _grid = __webpack_require__(/*! ./templates/grid.html */ "./templates/grid.html");
...
var ieSection = exports.ieSection = function () {
    function ieSection(containerId) {
        _classCallCheck(this, ieSection);

        this.$section = (0, _jquery2.default)('#' + containerId);
        this.draw();
    }

    _createClass(ieSection, [{
        key: 'draw',
        value: function draw() {
            this.$section.append((0, _lodash.template)(_ieTemplate2.default)({}));
        }
    }]);
...
var simpleMenuSection = exports.simpleMenuSection = function () {
    function simpleMenuSection(containerId) {
        _classCallCheck(this, simpleMenuSection);

        this.$section = (0, _jquery2.default)('#' + containerId);
        this.draw();
    }

    _createClass(simpleMenuSection, [{
        key: 'draw',
        value: function draw() {
            this.$section.append((0, _lodash.template)(_simpleMenu2.default)({}));
        }
    }]);

    return simpleMenuSection;
}();

var selectMenuSection = exports.selectMenuSection = function () {
    function selectMenuSection(containerId) {
        _classCallCheck(this, selectMenuSection);

        this.$section = (0, _jquery2.default)('#' + containerId);
        this.draw();
    }

    _createClass(selectMenuSection, [{
        key: 'draw',
        value: function draw() {
            this.$section.append((0, _lodash.template)(_checkboxesMenu2.default)({}));
        }
    }]);

    return selectMenuSection;
}();

var DialogSection = exports.DialogSection = function () {
    function DialogSection(containerId) {
    ...
    _createClass(DialogSection, [{
        key: 'draw',
        value: function draw() {
            this.$section.append((0, _lodash.template)(_Dialog2.default)({}));
        }
    }]);
...
var GridSection = exports.GridSection = function () {
    function GridSection(containerId) {
    ...
    _createClass(GridSection, [{
        key: 'draw',
        value: function draw() {
            this.$section.append((0, _lodash.template)(_grid2.default)({}));
        }
    }]);
...
var TableSection = exports.TableSection = function () {
    function TableSection(containerId) {
    ...
    _createClass(TableSection, [{
        key: 'draw',
        value: function draw() {
            this.$section.append((0, _lodash.template)(_table2.default)({}));
        }
    }]);
...
var _Menu = __webpack_require__(/*! ./Menu */ "./Menu.js");

var _Menu2 = _interopRequireDefault(_Menu);

var _selectableMenu = __webpack_require__(/*! ./selectableMenu */ "./selectableMenu.js");

var _selectableMenu2 = _interopRequireDefault(_selectableMenu);

var _DialogMenu = __webpack_require__(/*! ./DialogMenu */ "./DialogMenu.js");

var _DialogMenu2 = _interopRequireDefault(_DialogMenu);

var _IeMenu = __webpack_require__(/*! ./IeMenu */ "./IeMenu.js");

var _IeMenu2 = _interopRequireDefault(_IeMenu);

var _Grid = __webpack_require__(/*! ./Grid */ "./Grid.js");
...
var menuNoIe = new _IeMenu2.default('ieContainer1', items);
var menuIe = new _IeMenu2.default('ieContainer2', items);
menuNoIe.drawMenu();
menuIe.drawMenu_ie();

new _examplesSection.simpleMenuSection('2-simpleMenu');
var menu = new _Menu2.default('menuContainer1', items);
menu.drawMenu();

new _examplesSection.selectMenuSection('3-selectMenu');
var selectMenu = new _selectableMenu2.default('menuContainer2', items);
selectMenu.drawMenu();

new _examplesSection.DialogSection('4-dialog');
var dialog = new _DialogMenu2.default('menuContainer3', items);
dialog.drawMenu();

new _examplesSection.TableSection('5-table');
    ...
    _createClass(SelectableMenu, [{
        ...
        value: function _addMenuItems() {
            ...
            this.items.forEach(function (item, index) {
                ...
                _this2.$widgetList.append($menuItem);
                _this2.$dropdownItems.push($menuItem);
            });

            this.$widgetList.click(function (e) {
                _this2._handleSelect((0, _jquery2.default)(e.target));
            });
        }
    }, {
        key: '_handleSelect',
        value: function _handleSelect($currentItem) {
